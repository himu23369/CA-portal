  ...
  return (
    <section className="bg-gray-100 p-8">
      <div className="container mx-auto text-center">
        ...
        <a href={googleMapsLink} target="_blank" rel="noopener noreferrer" className="bg-sky-500 text-white px-6 py-3 rounded-md text-lg hover:bg-sky-400 focus:outline-none transition duration-300">
