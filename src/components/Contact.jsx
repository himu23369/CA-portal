      ...
      <div className="container mx-auto">
        ...
        <ul className="list-disc list-inside" style={listStyle}>
          <li className="flex items-center mb-2 transition duration-300 ease-in-out transform hover:scale-105" style={contactStyle}>
            ...
            <a href="tel:97817-04611" className="underline" style={linkStyle}>
              Call: 97817-04611
            </a>
          </li>
          <li className="flex items-center mb-2 transition duration-300 ease-in-out transform hover:scale-105" style={contactStyle}>
            <Mail size={16} className="inline mr-2" />
            <a href="mailto:ca.agarwalanandandco@gmail.com" className="underline" style={linkStyle}>
              Email: ca.agarwalanandandco@gmail.com
            </a>
          </li>
